...
className="bg-[#0f172a] border border-[#1e293b] rounded-2xl p-5 hover:border-[#0ea5e9] transition-all overflow-hidden h-full"    >
      ...
      <div className="space-y-2 break-words">
        <div className="flex justify-between items-baseline">
          ...
          <span className="text-xl font-bold text-[#0ea5e9] truncate ml-2">{formatINR(425000)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[#cbd5e1] text-sm">Monthly Income</span>
          <span className="text-[#10b981] font-semibold truncate ml-2">{formatINR(85000)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[#cbd5e1] text-sm">Monthly Expenses</span>
          <span className="text-[#ef4444] font-semibold truncate ml-2">{formatINR(52000)}</span>
        </div>
