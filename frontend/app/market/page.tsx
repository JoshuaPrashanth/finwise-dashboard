...
const cryptoData = [
  {
    ...
    change: 2.4,
    volume: "₹45,200 Cr",
    chartData: [42000, 43500, 45000, 44500, 46000, 47800, 48500],
    color: "#f7931a",
  },
  {
    name: "Ethereum",
    ...
    change: -0.8,
    volume: "₹22,100 Cr",
    chartData: [3100, 3050, 3150, 3200, 3180, 3120, 3080],
    color: "#627eea",
  },
  {
    name: "Binance Coin",
    ...
    change: 1.2,
    volume: "₹8,700 Cr",
    chartData: [580, 590, 585, 600, 610, 605, 612],
    color: "#f3ba2f",
  },
  {
    name: "Solana",
    ...
    change: 5.6,
    volume: "₹5,200 Cr",
    chartData: [140, 142, 148, 150, 155, 160, 165],
    color: "#14f195",
  },
  {
    name: "Cardano",
    ...
    change: -1.5,
    volume: "₹2,300 Cr",
    chartData: [0.45, 0.44, 0.43, 0.42, 0.41, 0.4, 0.39],
    color: "#0033ad",
  },
];
...
const stockData = [
  {
    ...
    change: 0.9,
    volume: "₹1,200 Cr",
    chartData: [2720, 2750, 2780, 2800, 2820, 2840, 2850],
    color: "#1e40af",
  },
  {
    ...
    change: -0.3,
    volume: "₹850 Cr",
    chartData: [3980, 3970, 3960, 3950, 3940, 3930, 3950],
    color: "#0f766e",
  },
  {
    name: "HDFC Bank",
    ...
    change: 1.2,
    volume: "₹950 Cr",
    chartData: [1620, 1635, 1650, 1660, 1670, 1675, 1680],
    color: "#b91c1c",
  },
  {
    name: "Infosys",
    ...
    change: -0.5,
    volume: "₹620 Cr",
    chartData: [1540, 1535, 1530, 1525, 1520, 1515, 1520],
    color: "#0ea5e9",
  },
  {
    name: "SBI",
    ...
    change: 2.1,
    volume: "₹1,500 Cr",
    chartData: [740, 750, 760, 770, 775, 780, 785],
    color: "#d97706",
  },
];
...
const indicesData = [
  {
    ...
    change: 0.7,
    points: 157,
    chartData: [22000, 22200, 22350, 22400, 22450, 22500, 22580],
    color: "#10b981",
  },
  {
    name: "SENSEX",
    ...
    change: 0.6,
    points: 442,
    chartData: [73000, 73500, 73800, 74000, 74100, 74200, 74250],
    color: "#0ea5e9",
  },
  {
    name: "BANK NIFTY",
    ...
    change: -0.2,
    points: -97,
    chartData: [48800, 48700, 48650, 48600, 48550, 48520, 48500],
    color: "#ef4444",
  },
];
...
const investmentIdeas = [
  {
    ...
    description: "Solar stocks expected to rise 15% in Q3",
    cta: "View Report",
  ...
  },
  {
    ...
    description: "Top AI companies to watch in 2025",
    cta: "Explore",
  ...
  },
  {
    ...
    description: "Start a tax-saving ELSS fund today",
    cta: "Apply Now",
...
const ads = [
  {
    title: "Trade Crypto with 0% Fees",
    company: "Binance",
...
const MarketTable = ({
  ...
  const sorted = [...filtered].sort((a, b) => {
    let aVal =
      sortKey === "price" ? (type === "index" ? a.value : a.price) : a.change;
    let bVal =
      sortKey === "price" ? (type === "index" ? b.value : b.price) : b.change;
      ...
      <div className="p-4 border-b border-[#1e293b] flex flex-wrap gap-3 justify-between items-center">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`text-xs px-3 py-1 rounded-full ${sortKey === "price" ? "bg-[#0ea5e9] text-black" : "bg-[#1e293b] text-[#94a3b8]"}`}
          >
            Price
          </button>
          <button
            ...
            className={`text-xs px-3 py-1 rounded-full ${sortKey === "change" ? "bg-[#0ea5e9] text-black" : "bg-[#1e293b] text-[#94a3b8]"}`}
          >
            Change
          </button>
        </div>
          ...
          <tbody>
            {sorted.map((item, idx) => (
              <motion.tr
                ...
                className="border-b border-[#1e293b] hover:bg-[#1e293b]/50"
              >
                <td className="p-3">
                ...
                <td className="p-3 text-right">
                  <span
                    className={`flex items-center justify-end gap-1 ${item.change >= 0 ? "text-[#10b981]" : "text-[#ef4444]"}`}
                  >
                    {item.change >= 0 ? (
                      <TrendingUp size={14} />
                    ) : (
...
function MarketPageContent() {
  const { userData } = useAuth(); // <-- added for current positions
  const [activeTab, setActiveTab] = useState<"crypto" | "stocks" | "indices">(
    "crypto",
  );
  const [marketNews, setMarketNews] = useState([
    ...
    {
      headline: "Bitcoin crosses ₹78 lakh amid ETF inflows",
      link: "https://cointelegraph.com",
    },
    {
      headline: "SEBI proposes new F&O regulations",
  ...
  return (
    <div className="min-h-screen bg-[#020617] pb-20 md:pb-0">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center gap-4 animate-marquee whitespace-nowrap">
            {marketNews.concat(marketNews).map((news, idx) => (
              <a
                ...
                className="text-[#cbd5e1] text-sm hover:text-[#0ea5e9] transition flex items-center gap-2"
              >
        ...
        {/* NEW: Current Positions Section */}
        {userData?.tradingPositions && userData.tradingPositions.length > 0 && (
          <div className="bg-[#0f172a] rounded-2xl p-5 border border-[#1e293b] mb-6">
            <h3 className="text-white font-semibold mb-4 flex items-center gap-2">
              <TrendingUp size={18} /> Current Positions
            </h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {userData.tradingPositions.map((pos, idx) => (
                    <tr key={idx} className="border-b border-[#1e293b]">
                      ...
                      <td className="p-2 text-right text-white">
                        {formatINR(pos.buyPrice)}
                      </td>
                      <td className="p-2 text-right text-white">
                        {formatINR(pos.currentPrice)}
                      </td>
                      <td
                        className={`p-2 text-right ${pos.pnl >= 0 ? "text-[#10b981]" : "text-[#ef4444]"}`}
                      >
                        {pos.pnl >= 0 ? "+" : ""}
                        {formatINR(pos.pnl)} ({pos.pnlPercent}%)
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex gap-2 bg-[#0f172a] p-1 rounded-xl w-fit border border-[#1e293b]">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 ${
                  activeTab === "crypto"
                    ? "bg-[#0ea5e9] text-black shadow-md"
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === "crypto" && (
                  <MarketTable data={cryptoData} type="crypto" />
                )}
                {activeTab === "stocks" && (
                  <MarketTable data={stockData} type="stock" />
                )}
                {activeTab === "indices" && (
                  <MarketTable data={indicesData} type="index" />
                )}
              </motion.div>
            </AnimatePresence>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-[#cbd5e1] text-sm mb-3">
                Bitcoin dominance rising – altcoin season may be delayed. Watch
                support at ₹74,000.
              </p>
            ...
            <div className="bg-[#0f172a] rounded-2xl p-5 border border-[#1e293b]">
              <h3 className="text-white font-semibold mb-3 flex items-center gap-2">
                <TrendingUp size={16} /> Investment Ideas
              </h3>
              <div className="space-y-3">
                {investmentIdeas.map((idea, idx) => (
                  <motion.a
                    ...
                    className="block p-3 bg-[#1e293b] rounded-xl hover:bg-[#334155] transition"
                  >
                    <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                {ads.map((ad, idx) => (
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.02 }}
                    className="flex items-center justify-between p-3 bg-gradient-to-r from-[#1e293b] to-[#0f172a] rounded-xl border border-[#334155]"
                  >
                    ...
                    <button className="text-[#0ea5e9] text-xs border border-[#0ea5e9] px-3 py-1 rounded-full hover:bg-[#0ea5e9] hover:text-black transition">
                      {ad.cta}
                    </button>
                  </motion.a>
                ))}
            ...
            <div className="bg-[#0f172a] rounded-2xl p-5 border border-[#1e293b]">
              ...
              <div className="grid grid-cols-2 gap-2">
                <a
                  ...
                  target="_blank"
                  className="text-[#cbd5e1] text-sm hover:text-[#0ea5e9] flex items-center gap-1"
                >
                ...
                <a
                  ...
                  className="text-[#cbd5e1] text-sm hover:text-[#0ea5e9] flex items-center gap-1"
                >
                  CoinGecko <ExternalLink size={12} />
                </a>
                <a
