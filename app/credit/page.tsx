...
import {
  ...
  Shield, CreditCard, Home, Car, GraduationCap, ArrowUpRight,
...
const loanHistory = [
  { id: 1, type: 'Home Loan', amount: 4500000, status: 'repaid', repaidDate: '15 Mar 2025', originalTenure: 120, actualTenure: 108 },
  { id: 2, type: 'Car Loan', amount: 800000, status: 'repaid', repaidDate: '10 Jan 2025', originalTenure: 60, actualTenure: 48 },
  { id: 3, type: 'Personal Loan', amount: 200000, status: 'lapsed', lapsedDate: '20 Feb 2025', reason: 'Missed 3 consecutive EMIs' },
]
...
const eligibilityRules = [
  { name: 'Home Loan', minScore: 650, eligible: CURRENT_SCORE >= 650, interestRate: '8.5% - 9.5%', maxAmount: '₹50 Lakh' },
  { name: 'Car Loan', minScore: 600, eligible: CURRENT_SCORE >= 600, interestRate: '7.8% - 8.8%', maxAmount: '₹15 Lakh' },
  { name: 'Personal Loan', minScore: 700, eligible: CURRENT_SCORE >= 700, interestRate: '10.5% - 12.5%', maxAmount: '₹10 Lakh' },
  { name: 'Education Loan', minScore: 550, eligible: CURRENT_SCORE >= 550, interestRate: '8.0% - 9.0%', maxAmount: '₹25 Lakh' },
  { name: 'Credit Card', minScore: 650, eligible: CURRENT_SCORE >= 650, interestRate: '18% - 24%', maxAmount: '₹2 Lakh' },
]
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <CreditScoreGauge score={CURRENT_SCORE} maxScore={MAX_SCORE} />
            <div className="mt-4 text-center">
              <p className="text-[#94a3b8] text-sm">Last updated: 10 April 2025</p>
              <p className="text-[#10b981] text-sm flex items-center justify-center gap-1 mt-1"><TrendingUp size={14} /> +12 points in 3 months</p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#0f172a] rounded-xl p-4 border border-[#1e293b]">
              ...
              <p className="text-[#10b981] text-xs mt-1">₹53 Lakh cleared</p>
            </div>
            <div className="bg-[#0f172a] rounded-xl p-4 border border-[#1e293b]">
              <p className="text-[#94a3b8] text-xs">Lapsed Loans</p>
              <p className="text-2xl font-bold text-white">1</p>
              <p className="text-[#ef4444] text-xs mt-1">₹2 Lakh defaulted</p>
            </div>
            <div className="bg-[#0f172a] rounded-xl p-4 border border-[#1e293b]">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loanHistory.map(loan => (
                  <tr key={loan.id} className="border-b border-[#1e293b]">
                    ...
                    <td className="p-2 text-[#94a3b8] text-xs">{loan.status === 'repaid' ? `Repaid on ${loan.repaidDate}` : `Lapsed on ${loan.lapsedDate} - ${loan.reason}`}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={scoreHistory}>
                  ...
                  <YAxis domain={[700, 800]} stroke="#94a3b8" />
